...
\begin{frame}
  ...
  \begin{figure}
    \centering
     \includegraphics[max size={\textwidth}{\textheight}]
     {figs/B2_instrument_fig1}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[max size={\textwidth}{\textheight}]{eb_maps}
  \end{figure}
\end{frame}
